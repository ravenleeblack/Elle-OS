...
// will support ascii but not unicode
#define ascii_null	0
#define ascii_soh	1
#define ASCII_STX	2
#define ASCII_ETX	3
...
// The following are not 7-bit ASCII values, they are abstract keycodes for commonly used keys, which are put in the upper half of a character value returned by the keyboard driver.
